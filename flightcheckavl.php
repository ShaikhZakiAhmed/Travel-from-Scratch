...
$sql="select * from flight where flight_id='$t_id' ";
$result=mysqli_query($con,$sql);
echo "<table width=100% border=1>";
echo "<tr><th>Flight NUMBER</th><th>Flight NAME</th><th>DATE</th><th>SOURCE</TH><th>DESTINATION</th><th>Seat Avilable</th></tr>";
