...
$sql="select * from bus where source='$sou' AND destination='$des' ";
$result=mysqli_query($con,$sql);
echo "<table width=100% border=1>";
echo "<tr><th>Bus NUMBER</th><th>Bus NAME</th><th>SOURCE</TH><th>DESTINATION</th><th>Check Avalibility</th></tr>";
echo "<form nmae=avilibility method=post action=buschekava.php>";
